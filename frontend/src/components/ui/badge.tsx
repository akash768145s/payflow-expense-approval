...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border px-2.5 py-0.5 text-[10px] font-bold tracking-wider uppercase transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        approved: 'border-transparent bg-emerald-100 text-emerald-800 dark:bg-emerald-950/20 dark:text-emerald-305',
